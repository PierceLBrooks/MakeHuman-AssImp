...
#ifndef MH_VECTOR_HPP
#define MH_VECTOR_HPP
...
typedef vec::Vector2<bool> structbvec2;

typedef vec::Vector2<int> structivec2;
typedef vec::Vector3<int> structivec3;
typedef vec::Vector4<int> structivec4;

typedef vec::Vector2<float> structvec2;
typedef vec::Vector3<float> structvec3;
typedef vec::Vector4<float> structvec4;
